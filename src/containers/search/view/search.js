...
import {view as SearchCommodityArea} from '../../../components/searchComponent/searchCommodityArea/'
import {view as RecommendSearchArea} from '../../../components/shareComponent/recommendSearchArea/'
        ...
        <Col  xs={24} sm={24} md={24} lg={24} xl={19} xxl={14}>
            <Row >
                <Col xs={24} sm={24} md={24} lg={24} xl={18} xxl={18}>
                    <Row>
                        <SearchCommodityArea keyWord={props.match.params.keyWord}/>
                    </Row>
                </Col>
