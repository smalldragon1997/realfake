...
class takeArea extends React.Component {
        ...
        return (
            <Spin spinning={isLoading}>
                <Steps style={{padding: "2%", paddingBottom: 0}}>
                    ...
                    <Step status="process" title="确认收货" icon={<Icon type="smile-o"/>}/>
                ...
                <div style={{padding: "1%", margin: "2%", backgroundColor: "#fff"}}>
                    {
                        orderInfo!==undefined ? (
                            <div>
                                ...
                                <Row style={{padding: "1%",backgroundColor:"#fff"}}>
                                    <Col span={24}
                                         style={{textAlign:"right",fontSize:20,color:"#00a9ff",fontWeight:"bold"}}>
                                        快递：{orderInfo.expMessage===null?null:orderInfo.expMessage+" "}
                                        <a onClick={()=>{
                                            window.open("http://www.baidu.com/s?wd="+orderInfo.number);
                                        }}>{orderInfo.number}</a>(点击可查看物流)
                                    </Col>
                                </Row>
                                <Row style={{padding: "1%",backgroundColor:"#fff"}}>
                                    <Col xs={24} sm={24} md={24} lg={24} xl={{ span: 8, offset:16 }} xxl={{ span: 8, offset: 16 }}>
                                        <Button type={"primary"} style={{width:"100%"}}
                                                onClick={()=>{
                                                    ...
                                                    setTimeout(()=>{
                                                        this.goEvaluate(userInfo.id,orderInfo.orderId)
                                                    },2000)
                                                }}>确认收货</Button>
                                    </Col>
                                </Row>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(takeArea));
